...
const commands = computed<Cmd[]>(() => [
  { id: 'about', label: 'Aller à ./about', hint: 'section', run: () => go('#about') },
  { id: 'experience', label: 'Aller à ./experience', hint: 'section', run: () => go('#experience') },
  { id: 'projects', label: 'Aller à ./projects', hint: 'section', run: () => go('#projects') },
  { id: 'skills', label: 'Aller à ./skills', hint: 'section', run: () => go('#skills') },
  { id: 'education', label: 'Aller à ./education', hint: 'section', run: () => go('#education') },
  { id: 'faq', label: 'Aller à ./faq', hint: 'section', run: () => go('#faq') },
  { id: 'contact', label: 'Aller à ./contact', hint: 'section', run: () => go('#contact') },
  {
    id: 'theme',
    label: `Changer de thème (actuel : ${theme.value})`,
    hint: 'action',
    run: () => {
  ...
  { id: 'matrix', label: 'Lancer l’effet Matrix', hint: 'fun', run: () => matrix.start(7000) },
  { id: 'snake', label: 'Jouer à Snake', hint: 'fun', run: () => arcade.start('snake') },
  {
    id: 'resume',
  ...
  >
    ...
    >
      ...
      <ul class="max-h-72 overflow-y-auto py-1 text-sm">
        <li v-if="!filtered.length" class="px-4 py-3 text-term-dim">Aucune commande.</li>
        <li
